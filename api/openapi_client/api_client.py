...
class Endpoint(object):
    ...
    def __call__(self, *args, **kwargs):
        ...
        api_instance = VcApi()
        api_instance.upload_file_get  # this is an instance of the class Endpoint
        api_instance.upload_file_get()  # this invokes api_instance.upload_file_get.__call__()
        which then invokes the callable functions stored in that endpoint at
        api_instance.upload_file_get.callable or self.callable in this class
